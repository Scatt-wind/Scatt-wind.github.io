...
- **下游**：无后端依赖；纯静态 CSS/JS（无 Chart.js 等外部图表库）
...
- 关于页样式前缀：`.about-skill-grid` / `.about-skill-tile` / `.about-skill-detail`；详情文案在模板 `<template>`，勿写回 JS
